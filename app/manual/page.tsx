  ...
  return (
    <main className="mx-auto flex w-full max-w-4xl flex-1 flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
      <PageHeader
        ...
        description="Erfassung mit Namenszuordnung, Zeitfenstern und direkter Punktevergabe."
      />
      <section className="rounded-lg border border-asphalt-200 bg-white p-4 shadow-line">
        <div className="flex items-start gap-3">
          ...
          <p className="text-sm leading-6 text-asphalt-600">
            Manuelle Einträge können dem Ranking ohne Strava Verknüpfung hinzugefügt werden. Einträge können nur im offenen Zeitfenster erfasst werden.
          </p>
        </div>
      </section>
      <ManualEntryPanel />
