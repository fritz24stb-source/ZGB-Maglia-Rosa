...
language sql stable security definer set search_path = public as $$
  ...
  ) select row_number() over(partition by season_id order by total_points desc,wins desc,second_places desc,third_places desc,fourth_places desc,fifth_places desc,combative_awards desc,display_name)::integer as place, user_id,display_name,season_id,season_name,total_points,wins,second_places,third_places,fourth_places,fifth_places,combative_awards,sprint_count from totals order by season_name,total_points desc,wins desc,second_places desc,third_places desc,fourth_places desc,fifth_places desc,combative_awards desc,display_name;
$$;
