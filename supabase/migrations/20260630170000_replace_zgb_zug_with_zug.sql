...
update public.manual_entry_windows
set
  category = 'zug',
  updated_at = now()
where category = 'zgb_zug';

update public.activities
set
  category = case when category = 'zgb_zug' then 'zug' else category end,
  matched_category = case
    when matched_category = 'zgb_zug' then 'zug'
    else matched_category
  end,
  updated_at = now()
where category = 'zgb_zug'
  or matched_category = 'zgb_zug';
